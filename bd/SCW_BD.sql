...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-07-2024 a las 21:53:20
...
(1, 'Juan', 'Sanchez', 'juansanchez@gmail.com', '12345', 'CC', 100286332, 1987364627, NULL, NULL);
...
--
ALTER TABLE `pagina`
  MODIFY `idpag` bigint(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `perxpag`
  MODIFY `idperpag` bigint(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuario`
  MODIFY `idusu` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
